    ...
    <div className="min-h-screen bg-[#03000A] text-white p-4">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row lg:gap-12">
          <div className="lg:w-2/3 post-content">
            <Suspense fallback={<PostSkeleton />}>
              <PostContent postId={params.id} />
            </Suspense>
          </div>

          <div className="lg:w-1/3 mt-12 lg:mt-0 related-post">
...
function PostSkeleton() {
  return (
    <div className="max-w-3xl mx-auto lg:mx-0 animate-pulse">
      <div className="h-8 md:h-10 lg:h-12 bg-gray-700 rounded w-3/4 mb-6 md:mb-8 skeleton-item"></div>
      <div className="h-48 md:h-56 lg:h-64 bg-gray-700 rounded mb-6 md:mb-8 skeleton-item"></div>
      <div className="space-y-3 md:space-y-4">
        ...
        <div className="h-3 md:h-4 bg-gray-700 rounded w-4/6 skeleton-item"></div>
      </div>
    </div>
  );
}
...
function RelatedPostSkeleton() {
  return (
    <div className="mt-8 md:mt-12 lg:mt-0 animate-pulse">
      <div className="h-6 md:h-8 bg-gray-700 rounded w-1/2 md:w-1/3 mb-4 md:mb-6 skeleton-item"></div>
