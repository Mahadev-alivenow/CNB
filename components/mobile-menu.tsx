    ...
    >
      ...
      >
        <div className="w-full flex justify-end">
          <button onClick={onClose} className="rounded-full bg-white p-2 hover:bg-gray-100 transition-colors">
            <X className="h-6 w-6 text-[#03000A]" />
          </button>
        </div>

        <nav className="flex-1 flex flex-col items-center justify-center gap-8 -mt-20">
          <Link href="/" className="text-2xl text-white hover:text-gray-200 transition-colors italic" onClick={onClose}>
            Home
          </Link>
          <Link
        ...
        <div className="w-full space-y-8">
          <div className="relative w-full">
            ...
            />
            <Search className="absolute right-0 bottom-2 h-6 w-6 text-white/50" />
          </div>
